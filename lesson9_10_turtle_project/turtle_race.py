...
# команди для перетворення в запускний файл
# 
# pip install pyinstaller

# Windows 
# pyinstaller --onefile --windowed --icon=turtle1.ico turtle_race.py

# Mac
# pyinstaller --onefile --windowed --icon=turtle1.icns turtle_race.py
